...
public class NotificationController {
    ...
    @ResponseStatus(code = HttpStatus.OK)
    public NotificationDetailDTO markAsReadWithPatch(@PathVariable Long notificationId)
            throws EntityNotFoundException {
        return new NotificationDetailDTO(notificationService.markNotificationAsRead(notificationId));
    }

    @PutMapping(value = "/{notificationId}/read")
    @ResponseStatus(code = HttpStatus.OK)
    public NotificationDetailDTO markAsRead(@PathVariable Long notificationId)
            throws EntityNotFoundException {
        return new NotificationDetailDTO(notificationService.markNotificationAsRead(notificationId));
    }
